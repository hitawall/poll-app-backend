...
// HasPolloptions applies the HasEdge predicate on the "polloptions" edge.
...
// HasPolloptionsWith applies the HasEdge predicate on the "polloptions" edge with a given conditions (other predicates).

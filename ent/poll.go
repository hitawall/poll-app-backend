...
type PollEdges struct {
	// Polloptions holds the value of the polloptions edge.
	Polloptions []*PollOption `json:"polloptions,omitempty"`
...
func (e PollEdges) PolloptionsOrErr() ([]*PollOption, error) {
	...
	return nil, &NotLoadedError{edge: "polloptions"}
}
...
// QueryPolloptions queries the "polloptions" edge of the Poll entity.
